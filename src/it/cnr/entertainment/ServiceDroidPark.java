	...
	private class IncomingHandler extends Handler { //gestisce la comunicazione tra i messenger di actvity e service (dall'activity al service)
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				...
				case SEND_QUEUE_MSG:{ //msg ricevuto dall'app quando crea una nuova QueueMsg
		...
		public void sendMulticastMSG(QueueMsg msg) {
			...
			if(adds!=null) { //qui ho cambiato l'utilizzo dell'iteratore
				...
				while (it.hasNext()) //qui c'̬ nullpointerexception perch̩ activechats non ha roomid
				{
